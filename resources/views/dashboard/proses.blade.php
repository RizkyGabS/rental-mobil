    ...
    if(isset($_POST['aksi'])){
        if($_POST['aksi'] == "add"){
            ...
            if($sql){
                ...
                // echo "Data berhasil ditambahkan<a href='/dashboard'>[Home]</a>";
            } else {
                echo $query;
            }
            ...
            echo "<br>Tambah Data <a href='/dashboard'>[Home]</a>";
        } else if($_POST['aksi'] == "edit"){
            echo "Edit Data <a href='/dashboard'>[Home]</a>";
            // var_dump($_POST);
...
;
    ...
    if(isset($_GET['hapus'])){
        ...
        // echo "Hapus Data <a href='/dashboard'>[Home]</a>";
    }
?>