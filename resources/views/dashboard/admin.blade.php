<?php
    include config_path('koneksi.php');
...
<body>
    ...
    <div class="container-fluid">
        ...
        <a href="/kelola" type="button" class="btn btn-primary mb-3">
        ...
        <div class="table-responsive">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="/kelola?ubah=<?php echo $result['id_kendaraan']; ?>" type="button" class="btn btn-success btn-sm"> <i class="fa fa-pencil"></i> </a>
                        <a href="/proses?hapus=<?php echo $result['id_kendaraan']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i> </a>
                    </td>
                </tr>
                <?php
                    }
